...
#### SELF PLAY
EPISODES = 20          	# Number of self play before retraining the model
MCTS_SIMS = 200        	# Number of MCTS simutations from one game state ( = number of node explored )
MEMORY_SIZE = 3000     	# Number of memories (training sample) keep for the model retraining
...
TRAINING_SET_SIZE = 512  # Training set size used during re-training - Sampled from the LT Memories
